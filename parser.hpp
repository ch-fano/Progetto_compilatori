...
# if 201103L <= YY_CPLUSPLUS
  ...
  private:
    ...
    union union_type
    {
      ...
      // globalvar
      char dummy6[sizeof (GlobalVarExprAST*)];

      // ifstmt
      char dummy7[sizeof (IfExprAST*)];
      ...
      // binding
      char dummy11[sizeof (VarBindingAST*)];
    ...
    TOK_LSQUARE = 275,             // "["
    TOK_RSQUARE = 276,             // "]"
    TOK_EXTERN = 277,              // "extern"
    TOK_DEF = 278,                 // "def"
    TOK_VAR = 279,                 // "var"
    TOK_GLOBAL = 280,              // "global"
    TOK_IF = 281,                  // "if"
    TOK_ELSE = 282,                // "else"
    TOK_FOR = 283,                 // "for"
    TOK_AND = 284,                 // "and"
    ...
    struct symbol_kind
    {
      enum symbol_kind_type
      {
        ...
        S_stmt = 45,                             // stmt
        S_ifstmt = 46,                           // ifstmt
        S_forstmt = 47,                          // forstmt
        S_init = 48,                             // init
        S_assignment = 49,                       // assignment
        S_exp = 50,                              // exp
        S_block = 51,                            // block
        S_vardefs = 52,                          // vardefs
        S_binding = 53,                          // binding
        S_initexp = 54,                          // initexp
        S_expif = 55,                            // expif
        S_condexp = 56,                          // condexp
        S_relexp = 57,                           // relexp
        S_idexp = 58,                            // idexp
        S_optexp = 59,                           // optexp
        S_explist = 60                           // explist
      };
    };
...
switch (yykind)
    ...
    // Implementation of make_symbol for each token kind.
      ...
      static
      symbol_type
      make_INCREASE (location_type l)
      {
        return symbol_type (token::TOK_INCREASE, std::move (l));
      }
#else
      static
      symbol_type
      make_INCREASE (const location_type& l)
      {
        return symbol_type (token::TOK_INCREASE, l);
      }
#endif
#if 201103L <= YY_CPLUSPLUS
      static
